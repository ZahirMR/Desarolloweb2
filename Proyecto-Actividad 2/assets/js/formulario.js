...
$(document).ready(function(){
    ...
    function obtenerMunicipios(departamento) {
        var municipiosPorDepartamento = {
            "Beni": ["Trinidad", "Riberalta", "Guayaramerin", "San Borja", "San Ignacio", "Rurrenabaque",
                ...
                "Puerto Siles"],
            "Cochabamba": ["Cochabamba", "Sacaba", "Quillacollo", "Villa Tunari", "Tiquipaya", "Colcapirhua",
                ...
                "Tacopaya", "Pojo"],
            "Chuquisaca": ["Sucre", "Yotala", "Poroma", "Presto", "El Villar", "Icla", "Tarabuco", "Villa Serrano",
            ...
            "La Paz": ["Achacachi", "Achocalla", "Aucapata", "Batallas", "Cairoma", "Calacoto", "Calamarca", "Callapa",
            ...
            "Oruro": ["Oruro", "Cercado", "Caracollo", "Huanuni", "Macha", "Santiago de Huari", "Eucaliptus", "Sabaya",
                ...
                "Santiago de Machaca"],
            "Pando": ["Cobija", "Porvenir", "Filotas", "Bolpebra", "El Sena", "Puerto Gonzalo Moreno", "Nueva Esperanza",
                "Santos Mercado", "Ingavi", "San Lorenzo", "Santa Rosa del Abuná", "Bella Flor", "Villa Nueva",
                "San Pedro", "San Pablo"],
            "Potosí": ["Potosí", "Uyuni", "Villazón", "Villa Imperial de Potosí", "Colcha K", "Tupiza", "Yocalla",
            ...
            "Santa Cruz De La Sierra": ["Santa Cruz de la Sierra", "El Torno", "Porongo", "La Guardia", "Puerto Pailas", "Cotoca",
            ...
            "Tarija": ["Tarija", "Yacuiba", "Villamontes", "Bermejo", "Caraparí", "Padcaya", "Entre Ríos", "Uriondo",
